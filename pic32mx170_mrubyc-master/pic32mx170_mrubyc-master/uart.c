...
void mrbc_init_class_uart(void)
{
  ...
  mrbc_value v_NONE = mrbc_integer_value(UART_NONE);
  mrbc_value v_ODD = mrbc_integer_value(UART_ODD);
  mrbc_value v_EVEN = mrbc_integer_value(UART_EVEN);
  mrbc_value v_RTSCTS = mrbc_integer_value(UART_RTSCTS);
  mrbc_set_class_const(uart, mrbc_str_to_symid("NONE"), &v_NONE);
  mrbc_set_class_const(uart, mrbc_str_to_symid("ODD"), &v_ODD);
  mrbc_set_class_const(uart, mrbc_str_to_symid("EVEN"), &v_EVEN);
  mrbc_set_class_const(uart, mrbc_str_to_symid("RTSCTS"), &v_RTSCTS);
}
