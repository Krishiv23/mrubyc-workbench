...
void mrbc_init_class_gpio( void )
{
  ...
  mrbc_value v_IN = mrbc_integer_value(GPIO_IN);
  mrbc_value v_OUT = mrbc_integer_value(GPIO_OUT);
  mrbc_value v_HIGH_Z = mrbc_integer_value(GPIO_HIGH_Z);
  mrbc_value v_PULL_UP = mrbc_integer_value(GPIO_PULL_UP);
  mrbc_value v_PULL_DOWN = mrbc_integer_value(GPIO_PULL_DOWN);
  mrbc_value v_OPEN_DRAIN = mrbc_integer_value(GPIO_OPEN_DRAIN);
  mrbc_set_class_const(gpio, mrbc_str_to_symid("IN"),         &v_IN);
  mrbc_set_class_const(gpio, mrbc_str_to_symid("OUT"),        &v_OUT);
  mrbc_set_class_const(gpio, mrbc_str_to_symid("HIGH_Z"),     &v_HIGH_Z);
  mrbc_set_class_const(gpio, mrbc_str_to_symid("PULL_UP"),    &v_PULL_UP);
  mrbc_set_class_const(gpio, mrbc_str_to_symid("PULL_DOWN"),  &v_PULL_DOWN);
  mrbc_set_class_const(gpio, mrbc_str_to_symid("OPEN_DRAIN"), &v_OPEN_DRAIN);
}
